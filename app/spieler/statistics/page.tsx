        ...
        <TabsContent value="scorers" className="mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-6">
            ...
            <Card className="dark-card">
              ...
              <CardContent>
                <div className="space-y-2">
                  {getTopPlayers("matches", 3).map((player, index) => (
                    <div key={player.id} className="flex items-center justify-between">
                      <div className="flex items-center">
                        <span className={`font-bold w-6 ${index < 3 ? "text-blue-400" : "text-gray-400"}`}>
                          {index + 1}.
                        </span>
                        <Link href={`/spieler/${player.id}`} className="text-white hover:text-blue-400 ml-1">
                          {player.first_name} {player.last_name}
                        </Link>
                      </div>
                      <span className="font-bold text-green-500">{player.matches_played}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <Card className="dark-card">
              ...
              <CardContent>
                <div className="space-y-2">
                  {getTopPlayers("minutes", 3).map((player, index) => (
                    <div key={player.id} className="flex items-center justify-between">
                      <div className="flex items-center">
                        <span className={`font-bold w-6 ${index < 3 ? "text-blue-400" : "text-gray-400"}`}>
                          {index + 1}.
                      ...
                      <span className="font-bold text-purple-500">{player.minutes_played}'</span>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <Card className="dark-card">
              ...
              <CardContent>
                <div className="space-y-2">
                  {getTopPlayers("goals_per_match", 3).map((player, index) => (
                    <div key={player.id} className="flex items-center justify-between">
                      <div className="flex items-center">
                        <span className={`font-bold w-6 ${index < 3 ? "text-blue-400" : "text-gray-400"}`}>
                          {index + 1}.
                      ...
                      <span className="font-bold text-blue-500">{player.goals_per_match}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <Card className="dark-card">
              ...
              <CardContent>
                <div className="space-y-2">
                  {getTopPlayers("clean_sheets", 3).map((player, index) => (
                    <div key={player.id} className="flex items-center justify-between">
                      <div className="flex items-center">
                        <span className={`font-bold w-6 ${index < 3 ? "text-blue-400" : "text-gray-400"}`}>
                          {index + 1}.
                      ...
                      <span className="font-bold text-yellow-500">{player.clean_sheets || 0}</span>
                    </div>
                  ))}
                </div>
              </CardContent>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden">
            <Table>
              <TableHeader className="bg-gray-800">
                <TableRow>
                  <TableHead className="text-gray-300">Spieler</TableHead>
                  <TableHead className="text-gray-300">Team</TableHead>
                  <TableHead className="text-gray-300 text-center">Tore</TableHead>
                  <TableHead className="text-gray-300 text-center">Vorlagen</TableHead>
                  <TableHead className="text-gray-300 text-center">Spiele</TableHead>
                  <TableHead className="text-gray-300 text-center">Minuten</TableHead>
                  <TableHead className="text-gray-300 text-center">Tore/Spiel</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {filteredPlayers.length === 0 ? (
                  ...
                  filteredPlayers.map((player, index) => (
                    <TableRow key={player.id} className="hover:bg-gray-800/50 border-gray-800">
                      <TableCell>
                        <Link href={`/spieler/${player.id}`} className="flex items-center hover:text-blue-400">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-gray-400 flex items-center">
                              ...
                              {player.jersey_number && (
                                <span className="ml-1 text-gray-500">#{player.jersey_number}</span>
                              )}
                            </div>
                          </div>
                        </Link>
                      ...
                      <TableCell>
                        <Link href={`/teams/${player.team_id}`} className="flex items-center hover:text-blue-400">
                          <div className="h-6 w-6 mr-2">
                            <img
                              src={player.team_logo_url || "/placeholder.svg?height=30&width=30&query=soccer team"}
                              alt={player.team_name}
                      ...
                      <TableCell className="text-center">
                        <span className="font-medium text-green-500">{player.assists}</span>
                      </TableCell>
                      <TableCell className="text-center">
                        <span className="text-gray-300">{player.matches_played}</span>
                      </TableCell>
                      <TableCell className="text-center">
                        <span className="text-gray-300">{player.minutes_played}'</span>
                      </TableCell>
                      <TableCell className="text-center">
                        <span className="text-yellow-500">{player.goals_per_match}</span>
                      </TableCell>
                    </TableRow>
                  ))
                )}
            ...
            <Table>
              <TableHeader className="bg-gray-800">
                <TableRow>
                  ...
                  <TableHead className="text-gray-300 text-center">Spiele</TableHead>
                  <TableHead className="text-gray-300 text-center">Minuten</TableHead>
                  <TableHead className="text-gray-300 text-center">Gelbe K.</TableHead>
                  <TableHead className="text-gray-300 text-center">Rote K.</TableHead>
                  <TableHead className="text-gray-300 text-center">Min/Tor</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {filteredPlayers.length === 0 ? (
                  ...
                  filteredPlayers.map((player, index) => (
                    <TableRow key={player.id} className="hover:bg-gray-800/50 border-gray-800">
                      ...
                      <TableCell className="text-center">
                        <span className={player.yellow_cards > 0 ? "text-yellow-500" : "text-gray-500"}>
                          {player.yellow_cards}
                        </span>
                      </TableCell>
                      <TableCell className="text-center">
                        <span className={player.red_cards > 0 ? "text-red-500" : "text-gray-500"}>
                          {player.red_cards}
                        </span>
                      </TableCell>
                      <TableCell className="text-center">
                        <span className="text-purple-400">
                          {player.minutes_per_goal !== null ? player.minutes_per_goal : "-"}
                        </span>
                      </TableCell>
                    </TableRow>
                  ))
