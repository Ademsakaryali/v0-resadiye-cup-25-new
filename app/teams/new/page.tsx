  ...
  useEffect(() => {
    const fetchTrainers = async () => {
      try {
        ...
        // Wenn der aktuelle Benutzer ein Trainer ist, setze ihn als Standard-Trainer
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {user?.rolle === "Trainer" && (
                    <p className="text-xs text-muted-foreground mt-1">
                      Als Trainer können Sie nur Teams für sich selbst erstellen.
                    </p>
                  )}
                </div>
              ...
              <CardFooter className="px-0 pt-6">
                ...
                >
                  {isLoading ? "Wird erstellt..." : "Team erstellen"}
                </Button>
              </CardFooter>
            </form>
          </CardContent>
